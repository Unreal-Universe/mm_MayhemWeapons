class ReflectiveShockBallFire extends ReflectiveShockBall;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         Texture=Texture'tk_MayhemWeapons.Shock.shock_core_low_FIRE'
         LifetimeRange=(Min=0.350000,Max=0.350000)
         WarmupTicksPerSecond=20.000000
         RelativeWarmupTime=1.000000
     End Object
     Emitters(0)=SpriteEmitter'tk_MayhemWeapons.ReflectiveShockBallFire.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         SpinParticles=True
         UniformSize=True
         ColorMultiplierRange=(Y=(Min=0.390000,Max=0.390000),Z=(Min=0.200000,Max=0.200000))
         ...
         Texture=Texture'tk_MayhemWeapons.Shock.shock_flare_a'
         LifetimeRange=(Min=0.400000,Max=0.400000)
         WarmupTicksPerSecond=20.000000
         RelativeWarmupTime=1.000000
     End Object
     Emitters(1)=SpriteEmitter'tk_MayhemWeapons.ReflectiveShockBallFire.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         Texture=Texture'tk_MayhemWeapons.Shock.shock_core'
         LifetimeRange=(Min=0.350000,Max=0.350000)
         ...
         RelativeWarmupTime=1.000000
     End Object
     Emitters(2)=SpriteEmitter'tk_MayhemWeapons.ReflectiveShockBallFire.SpriteEmitter2'
