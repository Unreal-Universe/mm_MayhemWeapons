class ColorLinkTrailRed extends ReflectiveNewLinkTrail;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'mm_MayhemWeapons.ColorLinkTrailRed.SpriteEmitter21'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter18
         ...
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=50,G=100,R=255))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=50,G=100,R=255))
     ...
     End Object
     Emitters(1)=SpriteEmitter'mm_MayhemWeapons.ColorLinkTrailRed.SpriteEmitter18'
