class ColorLinkTrailBlue extends ReflectiveNewLinkTrail;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'mm_MayhemWeapons.ColorLinkTrailBlue.SpriteEmitter21'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter18
         ...
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=255,G=200,R=100))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=255,G=200,R=100))
     ...
     End Object
     Emitters(1)=SpriteEmitter'mm_MayhemWeapons.ColorLinkTrailBlue.SpriteEmitter18'
